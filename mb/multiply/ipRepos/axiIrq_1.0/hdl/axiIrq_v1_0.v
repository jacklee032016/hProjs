...
`timescale 1 ns / 1 ps
	...
	(
		...
		// add params in top level module, JL
	...
	(
		...
		// add following 4 ports in top level module
		output wire PWM0,
		output wire PWM1,
		output wire PWM2,
		output wire PWM3,
...
// Instantiation of Axi Bus Interface S00_AXI
	...
	// change the instantiation of AXI bus interface
	axiIrq_v1_0_S00_AXI # ( 
		.C_S_AXI_DATA_WIDTH(C_S00_AXI_DATA_WIDTH),
		.C_S_AXI_ADDR_WIDTH(C_S00_AXI_ADDR_WIDTH),
		.PWM_COUNTER_MAX(PWM_COUNTER_MAX)  // add param from top to S00, JL
	) axiIrq_v1_0_S00_AXI_inst (
		.PWM0(PWM0),	// add port, JL
        .PWM1(PWM1),
        .PWM2(PWM2),
        .PWM3(PWM3),
